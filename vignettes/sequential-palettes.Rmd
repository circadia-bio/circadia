...
```{r simple-grid, fig.width = 8, fig.height = 6, fig.alt = "Four density heatmaps each using a different simple sequential palette", eval = requireNamespace("patchwork", quietly = TRUE)}
library(patchwork)
