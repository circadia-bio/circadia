...
```{r div-compare, fig.width = 9, fig.height = 3.5, fig.alt = "Side by side comparison of diverging and diverging_simple on a z-score heatmap", eval = requireNamespace("patchwork", quietly = TRUE)}
library(patchwork)
